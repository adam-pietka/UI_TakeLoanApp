package com.example.application.views.loans;
...
@PageTitle("Loans")
@Route(value = "Loans/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class LoansView extends Div implements BeforeEnterObserver {
    ...
    public LoansView(@Autowired SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("loans-view", "flex", "flex-col", "h-full");
        // Create UI
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(LoansView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(LoansView.class);
            }
        }
    }
