...
import stylesCss from 'themes/simpletakealoanapps/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import vaadinButtonCss from 'themes/simpletakealoanapps/components/vaadin-button.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_simpletakealoanapps_componentCss']) {
    registerStyles(
      'vaadin-button',
      css`
    ...
    document['_vaadintheme_simpletakealoanapps_componentCss'] = true;
  }
